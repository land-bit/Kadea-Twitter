...
export default function FolowBody({ data }) {
  return (
    <div className="flex py-[10px] justify-between">
      <Link to={data.user.userName} className="link flex">
        <img src={data.user.src} alt="image" className="w-[40px]" />
        <div>
      ...
      <button
        type="button"
        className="bg-white text-black w-[65px] px-[10px] my-[5px] rounded-[20px] border-none"
      >
        Follow
      </button>
    </div>
